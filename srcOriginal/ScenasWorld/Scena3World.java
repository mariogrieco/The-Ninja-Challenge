...
public class Scena3World implements Screem {
    ...
    public Scena3World() {
        ...
        y = (heigth / 2) + 50;
        try {
            fondo[0] = ImageIO.read(new File("src/level1/s3/Fondo/1.png"));
            border[0][0] = 0;
            border[0][1] = 0;
            border[0][2] = width;
            border[0][3] = heigth;

            fondo[1] = ImageIO.read(new File("src/level1/s3/Fondo/2.png"));
            border[1][0] = 0;
            ...
            retorno[1] = heigth - 181;
            retorno[2] = width;
            retorno[3] = 181;

            madera = ImageIO.read(new File("src/level1/s3/Fondo/madera.jpg"));
