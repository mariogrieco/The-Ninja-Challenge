...
public class Scena3Controller implements ActionListener, Screem {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (world.main.getRectangle().intersects(world.scena3.getRectangle(1)) || world.scena4.getRectangle(1).intersects(world.main.getRectangle()) || world.main.getRectangle().intersects(world.scena4.getRectangle(1))) {
