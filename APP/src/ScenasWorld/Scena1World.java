...
public class Scena1World implements Screem {
    ...
    public Scena1World() {
        ...
        try {
            fondo[0] = ImageIO.read(new File("src/level1/s1/fondo/1.jpg"));
            border[0][2] = width;
            border[0][3] = heigth;
            border[0][0] = 0;
            border[0][1] = 0;
        ...
        try {
            fondo[1] = ImageIO.read(new File("src/level1/s1/fondo/2.jpg"));
            border[1][2] = width;
            border[1][3] = 181;
         ...
         System.out.println("ScenasWorld.Scena1World.<load correct>()");
    }
